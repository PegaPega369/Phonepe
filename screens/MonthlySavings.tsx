...
const MonthlySavings: React.FC = () => {
  ...
  const [constantSavings, setConstantSavings] = useState('2000');
  const [selectedAmount, setSelectedAmount] = useState('2000');
  const savingType = "Monthly";
  ...
  const calculateSavings = (monthlyAmount: number) => {
    // 6 months of savings
    return Math.round(monthlyAmount * 6);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Monthly Savings</Text>
      ...
      >
        ...
        <View style={styles.heroSection}>
          ...
          >
            ...
            />
            <Text style={styles.bannerTitle}>Monthly Auto-Save</Text>
            <Text style={styles.bannerSubtitle}>
              Set aside a fixed amount every month to build your investment portfolio consistently
            </Text>
          </LinearGradient>
        </View>
        ...
        <View style={styles.amountSection}>
          <Text style={styles.sectionTitle}>Choose Monthly Amount</Text>
          ...
          >
            ...
            />
            <Text style={styles.perDayText}>/ month</Text>
          </LinearGradient>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.infoText}>
            The selected amount will be automatically invested monthly from your linked bank account
          </Text>
        </View>
      </ScrollView>
      ...
      <View style={styles.bottomContainer}>
        ...
        >
          ...
          >
            <Text style={styles.proceedButtonText}>Activate ₹{constantSavings} Monthly Savings</Text>
          </TouchableOpacity>
        </LinearGradient>
      </View>
    </View>
