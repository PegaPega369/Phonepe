...
const WeeklySavings: React.FC = () => {
  const navigation = useNavigation<NativeStackNavigationProp<any>>();
  const route = useRoute();
  const { uid } = route.params as RouteParams;

  const [constantSavings, setConstantSavings] = useState('200');
  const [selectedAmount, setSelectedAmount] = useState('200');
  const savingType = "Weekly";
  ...
  const calculateSavings = (weeklyAmount: number) => {
    // Assuming 26 weeks in 6 months
    return Math.round(weeklyAmount * 26);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Weekly Savings</Text>
      ...
      >
        ...
        <View style={styles.heroSection}>
          ...
          >
            ...
            />
            <Text style={styles.bannerTitle}>Weekly Auto-Save</Text>
            <Text style={styles.bannerSubtitle}>
              Set aside a fixed amount every week to build your investment portfolio consistently
            </Text>
          </LinearGradient>
        </View>
        ...
        <View style={styles.amountSection}>
          <Text style={styles.sectionTitle}>Choose Weekly Amount</Text>
          ...
          >
            ...
            />
            <Text style={styles.perDayText}>/ week</Text>
          </LinearGradient>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.infoText}>
            The selected amount will be automatically invested weekly from your linked bank account
          </Text>
        </View>
      </ScrollView>
      ...
      <View style={styles.bottomContainer}>
        ...
        >
          ...
          >
            <Text style={styles.proceedButtonText}>Activate ₹{constantSavings} Weekly Savings</Text>
          </TouchableOpacity>
        </LinearGradient>
      </View>
    </View>
